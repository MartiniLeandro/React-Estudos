...
import type { ContratoCardsDTO } from '../../services/contratosService';

interface EspecialCardsProps {
  resumo: ContratoCardsDTO | null;
  loading?: boolean;
}

export default function EspecialCards({ resumo, loading }: EspecialCardsProps) {
  console.log('RESUMO ESPECIAL:', resumo);
  ...
  const cards = [
    ...
    },
    {
      ...
      value: resumo?.ContratosproximosDoFim ?? 0,
      description: 'Contratos terminam em até 30 dias',
    ...
    {
      title: 'Inadimplentes',
      value: resumo?.contratosInadimplencia ?? 0,
